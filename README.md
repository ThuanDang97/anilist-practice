...
- Debug tools: [React DevTools](https://chrome.google.com/webstore/detail/react-developer-tools/fmkadmapgofadopljbjfkapdkoienihi)<span style="text-decoration:underline;">.</span> Supporters have to present how this tool works.
